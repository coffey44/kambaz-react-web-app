    ...
    return (
        <div id ="wd-lab1">
            <h2>Lab 1</h2>
                ...
                How to make a bacon egg and cheese:
                <ol id="wd-your-favorite-recipe">
                
                    <li>Fry Two Eggs</li>
                    <li>Flip and put cheese on eggs</li>
                    <li>Cook two pieces of bacon</li>
                    <li>Toast a bagel of your choice</li>
                    <li>Assemble the bacon egg and cheese</li>
                </ol>
                ...
                <h4>Form Elements</h4>
                    <form id="wd-text-fields">
                        ...
                        <textarea id="wd-textarea" cols={30} rows={10}>
                            ...
                            Proin euismod vitae neque et mattis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                            In ultrices molestie enim, volutpat vulputate augue euismod non.
                            Pellentesque blandit dictum tellus. 
                            Donec lectus justo, mattis in vehicula eget, pulvinar et metus. 
                            In commodo cursus orci vitae ultrices. Maecenas ac ante consequat, convallis orci quis, convallis enim. 
                            Aliquam posuere nisl vitae vestibulum accumsan. Praesent consectetur volutpat nibh tempor venenatis. 
                            Donec ut arcu erat. Sed dolor erat, blandit faucibus purus quis, mollis accumsan leo. 
                            Aliquam in felis a tortor imperdiet sagittis sit amet in lectus. Curabitur eget purus mi.
