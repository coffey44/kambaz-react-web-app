...
export default function ModulesControls(
 ...
 return (
   <div id="wd-modules-controls" className="text-nowrap d-flex flex-row-reverse gap-2 mb-3 align-items-center">
    ...
    <Button variant="secondary" size="lg" id="wd-view-progress">View Progress</Button>
